...
function ProjectList({ selectedCategories }: { selectedCategories: string[] }) {
  ...
  useEffect(() => {
    ...
    loadProjects();
  }, [pageSize, pageNum, selectedCategories]); // Watching the dependency array to see if we need to fetch new data when the page size changes. // Watches the pageNum variable to see when to fetch the next page data.
